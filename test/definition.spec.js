...
//   describe('Definition.getSchema()', () => {
//     it('should raise exception if schema method is not defined', () => {
//       try {
//         Definition.getSchema('DefinitionName')

//       } catch (error) {
//         expect(error.message).to.equal('Definition.getSchema() is not defined')
//         return
//       }
...
//       } catch (error) {
//         expect(error.message).to.equal('NoSchema.schema is not defined')
//         return
//       }
