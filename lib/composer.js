  ...
  get spec() {
    ...
    for (const module of this.modules) {
      ...
      for (const klass of klasses) {
        if (klass.prototype instanceof Operation) {
          Object.assign(spec.paths, klass.spec)

        } else if (klass.prototype instanceof Definition) {
          const definition = {}
          definition[klass.name] = klass.spec
          Object.assign(spec.definitions, definition)

        } else if (klass.prototype instanceof Security) {
